...
class ViewController: UIViewController , ColorTableViewControllerDelegate{
    ...
    @IBOutlet weak var R_G_B_label: UILabel!
    @IBOutlet weak var H_S_L_label: UILabel!
    @IBOutlet weak var H_S_V_label: UILabel!
    ...
    func ColorTableViewChooseColor(controller: ColorTableViewController, chosenColor color: String){
        ...
        History1.backgroundColor = chosenColorLabel.backgroundColor
        ...
        R_G_B_label.text = "R.G.B: \(r),\(g),\(b)"
        let hsl = myColors.fetchHSL(color)
        H_S_L_label.text = "H.S.L: \(hsl.H),\(hsl.S),\(hsl.L)"
        let hsv = myColors.fetchHSV(color)
        H_S_V_label.text = "H.S.V: \(hsv.H),\(hsv.S),\(hsv.V)"
