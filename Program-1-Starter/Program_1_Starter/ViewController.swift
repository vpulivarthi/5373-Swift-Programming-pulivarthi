...
class ViewController: UIViewController {
    ...
    func matchColorLogic() -> Bool{
        ...
        btnAnswer1OUTLET.titleLabel?.numberOfLines = 3
        btnAnswer2OUTLET.titleLabel?.numberOfLines = 3
        btnAnswer3OUTLET.titleLabel?.numberOfLines = 3
    ...
    func changeColor(strValue:String) -> Bool{
        lblChangeColor.backgroundColor = myColors.hexStringToUIColor(strValue)
