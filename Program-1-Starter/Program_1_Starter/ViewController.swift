...
class ViewController: UIViewController {
    ...
    func matchColorLogic() -> Bool{
        ...
        var color1 = self.myColors.fetchRandomColor()
        var color2 = self.myColors.fetchRandomColor()
        var color3 = self.myColors.fetchRandomColor()
        ...
        if(buttonAnswer == 0)
        {
            btnAnswer1OUTLET.setTitle(color1.colorName, forState: UIControlState.Normal)
            btnAnswer2OUTLET.setTitle(color2.colorName, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(color3.colorName, forState: UIControlState.Normal)
            button1Correct=true
            button2Correct=false
            button3Correct=false
        }
        ...
        if(buttonAnswer == 1)
        {
            btnAnswer1OUTLET.setTitle(color2.colorName, forState: UIControlState.Normal)
            btnAnswer2OUTLET.setTitle(color1.colorName, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(color3.colorName, forState: UIControlState.Normal)
            button2Correct=true
            button1Correct=false
            button3Correct=false
        ...
        if(buttonAnswer == 2)
        {
            btnAnswer1OUTLET.setTitle(color3.colorName, forState: UIControlState.Normal)
            btnAnswer2OUTLET.setTitle(color2.colorName, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(color1.colorName, forState: UIControlState.Normal)
            button3Correct=true
            button1Correct=false
            button2Correct=false
        }
    ...
    func changeColor(color: (colorName:String,hexValue:String,rgb:RGB,hsl:HSL,hsv:HSV)) -> Bool{
        
        var backColor = self.myColors.hexStringToUIColor(color.hexValue)
        lblChangeColor.backgroundColor = backColor
